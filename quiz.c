/*
********************************QUIZ PROGRAM**************************
programmed by:  Laxmi Kadariya
email address: laxmi.jhapa@gmail.ccom
compiled IDE:   codeblocks 10.05
...
void help()
 ...
 system("cls");
 //gotoxy(30,8);
 //SetColorAdjustment(HDC, 4*);
 printf("\n================================================================================\n");
 SetColorAndBackground(10,4);
 printf("\t\t\t\tHELP");
 printf("\n\n\n\t1.This is a simple quiz game written as a simple project in c");
 printf("\n\n\n\t2.The question are provided with four options");
 printf("\n\n\n\t3.the answer to it will be evaluated and the score will be displayed at ");
 printf("\n\tlast Remember that the more quicker you give answer the more");
 printf("\n\tscore you will secure. ");
 printf("\n\n\n\t4.If you secure highest score, your score");
 printf("\n\twill be recorded.\n\n\n");
 printf("\t.....................BEST OF LUCK......................");
  printf("\n================================================================================\n");
 }
...
int main()
     ...
     puts("\n\t\t Enter 'hscore' to view high score  ");
     puts("\n\t\t Enter 'help' for help            ");
     puts("\n\t\t Enter 'quit' to quit             ");
     printf("\n\t\t-------------------------------\n\n\t\t  ");
     gets(choice);
     if (strcmp(choice,"hscore")==0)
 {
 displayscore();
 goto mainhome;
 }
 ...
 goto mainhome;
  ...
  printf("\n================================================================================\n");
     ...
     printf("\n\n\t\t\t please wait!! It may takes few seconds\n\n");
     printf("\n\t\t\t\t       10 %");
     printf("\n\t\t\t\t     loading");
      Sleep(3000);
     system("cls");
  ...
  printf("\n================================================================================\n");
     ...
     system("cls");
     printf("\n\n********************************  created   *********************************\n\n");
     printf("\t\t\tsuccessfully created your profile\n");
     ...
     start:
     srand ( time(NULL) );
     r=rand()%24+1;                  // Generates the random selection of the question
                                     //rand() is a library function that generates the random number
     nq[i]=r;
     for (w=0;w<i;w++)
 if (nq[w]==r) goto start;
  ...
  case 5:
  printf("\n\n\nWhich country won the Fifa World Cup 2010?");
  printf("\n\nA.Spain\tB.Brazil\n\nC.Italy\tD.England\n\n");
  countq++;
  if (toupper(getch())=='A')
   {printf("\n\nCorrect!!!");countr++; break;}
  else
         {printf("\n\nWrong!!! The correct answer is A.Spain");break;}
  ...
  printf("\n\nA.Dr Baburam Bhattarai\tB. Puspa Kamal Dahal\n\nC.Dr Ram Baran Yadav\t Giraja Pd Koirala");
  countq++;
  if (toupper(getch())=='C')
   {printf("\n\nCorrect!!!");countr++; break;}
  else
 ...
 case 24:
  ...
  printf("\n\nA.Pokhara\tB.Biratnagar\n\nC.Dhankutta\tD.Kathmandu\n\n");
  countq++;
  if (toupper(getch())=='D')
   {printf("\n\nCorrect!!!");countr++; break;}
  else
         {printf("\n\nWrong!!! The correct answer is D.Kathmandu");break;}
